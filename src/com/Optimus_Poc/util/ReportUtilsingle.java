...
/**
 * @version - MHR_v.7(Report folder overriding feature)
...
public class ReportUtil {
	...
	public static void main(String[] arg) throws Exception {
		...
		try {
			...
			fs = new FileInputStream(System.getProperty("user.dir") + "//src//com//automation//config//config.properties");
			...
			for (int currentSuiteID = 2; currentSuiteID <= totalTestSuites; currentSuiteID++) {
				...
				currentSuiteXLS = new Xls_Reader(System.getProperty("user.dir") + "//src//com//automation//xls//" + currentTestSuite + ".xlsx");
